...
import { ArrowRight, Utensils, DollarSign, Package, Image as ImageIcon, PlusCircle, Loader2, Store } from 'lucide-react'
...
export default function AddMealPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("🎉 تم إرسال منتجك بنجاح! سيظهر للزبائن بمجرد موافقة الإدارة.")
    ...
    <div className="min-h-screen bg-gray-50 text-right font-sans pb-10" dir="rtl">
      ...
      <form onSubmit={handleSubmit} className="px-6 space-y-4">
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-[2] bg-white p-4 rounded-3xl shadow-sm border border-gray-100">
            <label className="text-xs font-black text-gray-400 mb-2 block">رابط الصورة</label>
            <div className="flex items-center gap-2 bg-gray-50 p-3 rounded-2xl">
        ...
        <button type="submit" disabled={loading} className="w-full bg-emerald-800 text-white p-5 rounded-3xl font-black flex items-center justify-center gap-2 shadow-xl shadow-emerald-900/20 active:scale-95 transition-all mt-4">
