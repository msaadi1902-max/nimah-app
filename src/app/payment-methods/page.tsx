...
export default function PaymentMethodsPage() {
  ...
  const paymentOptions = [
    ...
    { id: 'paypal', name: 'باي بال (PayPal)', icon: Globe, color: 'text-sky-500', desc: 'دفع إلكتروني آمن وسريع', bg: 'bg-sky-50' },
          ...
          <div className="flex items-start gap-4 relative z-10">
            ...
            <div className="text-right">
              ...
              <p className="text-[10px] text-gray-400 leading-loose font-bold">
                نحن نستخدم تشفير <span className="text-emerald-400">AES-256</span> العالمي. بياناتك المالية لا يتم تخزينها على خوادمنا الشخصية بل تتم معالجتها عبر بوابات دفع دولية مرخصة.
              </p>
            </div>
          </div>
        </div>
